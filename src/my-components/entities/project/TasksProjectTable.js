...
function TasksProjectTable(props) {
    const {
        rows, count, page, pageSize: rowsPerPage,
        fetchTasks, displayProjectName,
    } = props;
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">
                                                <Link component={RouterLink}
                                                      to={`/project/${row.sprint.project.id}`}>
                                                    {getDisplayString(row.sprint.project.designation, 40)}
                                                </Link>
                                            </TableCell>
                                            }
                                            ...
                                            <TableCell
                                                align="left">{getStatusElement(row.status)}</TableCell>
                                            <TableCell
                                                align="left">{moment(row.start_at).format('L')}
                                            </TableCell>
                                            <TableCell
                                                align="left">{moment(row.end_at).format('L')}
                                            </TableCell>
                                        </TableRow>
                                    );
                                })}
